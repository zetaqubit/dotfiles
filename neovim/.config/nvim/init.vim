...
" Configure editor root to be at .vim or .config/nvim
if (is_nvim)
...
" Neovim specific.
if (is_nvim)
  " C-h is interpreted as backspace.
  "nnoremap <BS>  <C-w>h

  " Moving out of terminal windows.
  ...
  tnoremap <Esc>b <S-Left>
  tnoremap <Esc>f <S-Right>
endif

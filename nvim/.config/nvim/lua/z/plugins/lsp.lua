	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				map("gp", vim.lsp.buf.hover, "[G]o [P]eek at documentation under cursor")
				...
				map("<leader>D", require("fzf-lua").lsp_document_diagnostics, "Show buffer [D]iagnostics")
